...
!(function () {
  ...
  function mouseDownHandler(e) {
    ...
    createFireworks(x, y, ["宝宝", "爱你哟", "最喜欢你啦", "猪猪", "燕宝", "憨憨", "香宝", "臭宝", "坏宝宝", "好宝宝"][Math.floor(Math.random() * 10)]);
  }
  ...
  function createFireworks(x, y, text = "") {
    ...
    if (text != "") {
      ...
      for (var i = 0; i < count; i++) {
        ...
        //大小
        p.size = Math.random() * 3 + 1.7;

        //速度
        p.speed = Math.random() * 7 + .7;

        //半径
        p.radius = Math.random() * 77 + 52;
